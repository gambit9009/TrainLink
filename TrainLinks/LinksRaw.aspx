<%@ Page Title="Helpful Links" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LinksRaw.aspx.cs" Inherits="TrainLinks._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form id="form1" runat="server">
        <table style="border-style: 0; border-width: 0px; background-color: #FFFFFF; padding: 0px; margin: 0px; vertical-align: top; width: 90%;" border="0" class="Todd"><tr>
            <td style="padding: 0px; margin: 0px; font-size: x-large; background-color: #FFFFFF;">&nbsp;&nbsp;<b>Lord of the Links&nbsp;</b>
                <asp:Label ID="Label1" runat="server" Text="Label" Font-Size="Small">&nbsp;&nbsp;&nbsp;One Link to rule them all, One Link to find them, One Link to bring them all and in the darkness bind them&nbsp;&nbsp;&nbsp;&nbsp;</asp:Label>
            </td></tr>
            <tr style="border-width: 0px; border-color: #FFFFFF"><td style="border-width: 0px; border-color: #FFFFFF; padding: 0px; margin: 0px; font-size: small; background-color: #FFFFFF;" >**** The current view for this web page is just the raw data...so for now is it really wide.  Use web browse Find to do a search or click headers to sort.</td></tr>
        </table>
